...
FILE_LOCATION = r"G:\datasets\s07\out.csv" #out.csv is the file containing extracted metadata from the images
...
print(fd)
fd.to_csv(r'G:\datasets\s07\my_data1.csv', index=False)
...
print(df3.columns)
df3.to_csv(r'G:\datasets\s07\my_data2.csv', index=False)
